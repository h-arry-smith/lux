...
- [ ] Get the auto dmx offset working in the fixture DSL
- [ ] Get this working for a simple dimmer rig, with debug output and the likes
- [ ] Get this working for the current moving light
- [ ] Add min, max and fine to the DSL
- [ ] Give the lighting engine real time and eval delay and fades properly
